...
export default async function ServicesAdminPage() {
  ...
  return (
    <div>
      <PageHeader title="Services" note="Draft catalog pages stay unpublished until status is active and indexable. Do not invent licenses." />
      <AdminTable headers={["Slug", "Name", "Status", "Indexable", ""]}>
        {rows.map((row) => (
