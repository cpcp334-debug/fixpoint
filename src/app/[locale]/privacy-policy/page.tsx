...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return buildMetadata({ locale, title: `${t("privacyTitle")} | ALNAJAH ALDAEM`, description: t("privacyTitle"), path: "/privacy-policy" });
}
      ...
      <Section>
        ...
        {ar ? (
          <div className="mt-4 max-w-3xl space-y-4 text-muted">
            <p>تجمع النجاح الدائم بيانات التواصل التي ترسلها عبر النماذج (الاسم والهاتف والبريد والرسالة وموقع الخدمة) للرد على الطلبات. لا نبيع بياناتك.</p>
          ...
          <div className="mt-4 max-w-3xl space-y-4 text-muted">
            <p>ALNAJAH ALDAEM collects contact details you submit through forms (name, phone, email, message, and service location) so we can respond to enquiries. We do not sell this information.</p>
